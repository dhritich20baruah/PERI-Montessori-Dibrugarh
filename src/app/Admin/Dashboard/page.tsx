  ...
  return (
    <>
      ...
      <div className="grid md:grid-cols-3 md:grid-rows-2 gap-3 md:mx-32 text-xl grid-cols-2 grid-rows-3 mx-5">
        <Link href='/' className="bg-orange-600 text-white text-center p-10 hover:text-orange-600 hover:bg-white shadow-lg shadow-black hover:cursor-pointer">
        ...
        <div onClick={logout} className="bg-orange-600 text-white text-center p-10 hover:text-orange-600 hover:bg-white shadow-lg shadow-black hover:cursor-pointer">
